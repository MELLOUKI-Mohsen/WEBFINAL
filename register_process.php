...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        try {
            ...
            echo 'localStorage.setItem("userName", "' . addslashes($name) . '");';
            echo 'localStorage.setItem("userType", "' . $account_type . '");';
    ...
    if (!empty($errors)) {
        ...
        header("Location: ../register.php" . (isset($_POST['account_type']) && $_POST['account_type'] === 'company' ? '?type=company' : ''));
        exit();
    }
}
?>
